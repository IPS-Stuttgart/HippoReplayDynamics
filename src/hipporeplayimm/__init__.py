...
from . import accuracy_grid_parameter_validation as _accuracy_grid_parameter_validation
...
from . import advanced_result_evidence_margin_duplicates as _advanced_result_evidence_margin_duplicates
...
from . import kd_grid_prior_support as _kd_grid_prior_support
...
def apply_runtime_patches() -> None:
    ...
    _kd_grid_prior_support.apply_kd_grid_prior_support_patch()
    ...
    _advanced_result_evidence_margin_duplicates.apply_evidence_margin_distinct_model_patch()
