...
def test_evidence_status_patch_repatches_stale_recovery_diagnostics_helper(monkeypatch) -> None:
    ...
    assert getattr(diagnostics._successful_finite_scores, status_coercion._RECOVERY_DIAGNOSTICS_WRAPPER_FLAG, False)
