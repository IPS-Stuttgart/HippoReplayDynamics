...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"alpha": True}, "alpha must be finite and positive"),
        ({"alpha": np.array([0.8])}, "alpha must be finite and positive"),
        ({"beta": np.nan}, "beta must be finite and positive"),
        ({"beta": False}, "beta must be finite and positive"),
